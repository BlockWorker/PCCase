...
#define NVMWriteWord(addr, data) (NVM_WordWrite((uint32_t)(data), (uint32_t)(addr)), _nvm_waitbusy(), NVM_ErrorGet())
#define NVMErasePage(addr) (NVM_PageErase((uint32_t)(addr)), _nvm_waitbusy(), NVM_ErrorGet())


//For the DEE emulation operation 3 Pages should be allocated in the program memory.
unsigned int eedata_addr[NUM_DATA_EE_PAGES][NUMBER_OF_INSTRUCTIONS_IN_PAGE] __attribute__ ((space(prog),address(0xBD004000))) = {{0, 0xffffffffu}, {0}, {0}};
unsigned int eedata_addr_c[NUM_DATA_EE_PAGES][NUMBER_OF_INSTRUCTIONS_IN_PAGE] __attribute__ ((space(prog),address(0x9D004000))) = {{0, 0xffffffffu}, {0}, {0}};
