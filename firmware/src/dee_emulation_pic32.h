...
#define NUM_DATA_EE_PAGES   (3) // Total number of pages reserved for the operation
    ...
    // Internal constants
#define ERASE_WRITE_CYCLE_MAX           (8000) // Maximum erase cycle per page
#define NUMBER_OF_INSTRUCTIONS_IN_PAGE  (4096) // number of 32-bit word instructions per page
#define DATA_OFFSET                     (5456) // The point where address starts
